...
## R. Das 50 amostras geradas 3 delas, representadas por linhas vermelhas no gráfico, não contém
## a média real da população. A proporção encontrada, 94% é inferior ao nível de confiança de 95%.
## Provavelmente é pelo fato de serem somente 50 amostras de tamnho pequeno.
...
## R. Para 97% de confiança desejada o valor crítico é 2.17009
...
## R. A proporção encontrada foi 98%, bem próxima a confiança escolhida de 97%.
